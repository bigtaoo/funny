...
function matchStartMsg(seed: number, localSide: number, startFrame = 0): ServerMsg {
  return {
    matchStart: { roomId: 'room-1', mode: 0, seed, startFrame, localSide, opponentName: '', opponentPublicId: '', opponentTitle: '', opponentAvatarId: '', opponentSkins: [], topDeck: [], bottomDeck: [] },
  } as ServerMsg;
}
