...
const MINE_TILE_MENU_LABELS = [t('world.actReinforce'), t('world.actMove'), t('world.actGarrison'), t('world.actDefense'), t('world.actWatchtower'), t('world.actArrowTower'), t('world.actBlocker'), t('world.actRelocate'), t('world.actAbandon'), '✕'];
// Relocate is only offered when the player already has a main base (me.mainBaseTile set).
const MINE_TILE_MENU_LABELS_NO_BASE = [t('world.actReinforce'), t('world.actMove'), t('world.actGarrison'), t('world.actDefense'), t('world.actWatchtower'), t('world.actArrowTower'), t('world.actBlocker'), t('world.actAbandon'), '✕'];
