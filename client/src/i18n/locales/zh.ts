...
export const zh = {
  ...
  'roster.feedBtn': '携手成长',
  'roster.feedTitle': '选择伙伴卡',
  'roster.feedHint': '同阵营伙伴（70%效率）',
  'roster.feedEmpty': '无可用伙伴卡',
  'roster.feedConfirm': '让以下 {n} 位伙伴与 {name} 携手成长？',
  'roster.feedOk': '携手成长完成',
  'roster.feedErr': '携手成长失败',
  'roster.lockOk': '已锁定',
  'roster.unlockOk': '已解锁',
