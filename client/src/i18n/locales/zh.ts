...
export const zh = {
  ...
  'settings.audioBgm': '音乐',
  'settings.audioSfx': '音效',
  'settings.audioMuteOn': '已静音',
  'settings.audioMuteOff': '有声',
  ...
  'shop.rechargeSuccessNamed': '支付成功：+{n} 金币',
  ...
  'world.actArrowTower': '箭塔',
  'world.actBlocker': '阻挡',
  'world.actDemolish': '拆除',
  ...
  'city.speedupDoneNamed': '已加速：{name}',
  'city.upgrade': '升级',
  'city.upgrading': '建造中',
  'city.maxLevel': '已满级',
