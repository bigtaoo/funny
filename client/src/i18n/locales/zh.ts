...
export const zh = {
  ...
  'campaign.epilogue': '多年以后，陶收拾行李准备离开。Anna 把她的本子递过来，没有解释为什么。陶接了，也没有问。\n再后来，陶把两本笔记本从书架深处翻出来——他的，还有 Anna 那本，边角都卷了。\n他坐在电脑前，把两本摞在一起，从自己的第一页开始翻。父亲当年送的深蓝色封面还在，边上的毛边比记忆里更明显。\n翻到最后一页，陶合上本子，开了一个新文件。这一次，他不是在方格纸上画小人了。',
