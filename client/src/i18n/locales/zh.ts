...
export const zh = {
  ...
  'settings.avatarTab.equip': '装备',
  'settings.avatarTab.material': '材料',
  'settings.avatarTab.skin': '皮肤',
  'settings.avatarLocked.title': '获得该称号后即可用作头像',
  'settings.avatarLocked.hero': '获得该角色后即可用作头像',
  'settings.avatarLocked.equip': '获得该装备后即可用作头像',
  'settings.avatarLocked.material': '获得该材料后即可用作头像',
