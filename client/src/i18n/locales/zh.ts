...
export const zh = {
  ...
  'story.line.5': '后来，他在上面画了一个角色。又画了一个。',
  'story.line.6': '角色有了名字，有了要去的地方，有了非打不可的仗。',
  ...
  'campaign.ch6.lv10.brief': '两支队伍第二次相遇，也是打得最好的一场——谁都没留手，每一步都被接住，每个空隙都被看穿。Hartmann 输了，输得心服。赛后，Mara 走向苏远，两人站了一会儿，谁都没开口。末了，Mara 说：「是信任。」苏远看着她，点了头，没多说。Mara 又说：「我们也有，只是方式不一样。」苏远说：「我知道。」两支队伍，将代表各自的宗门走向更大的舞台。那个舞台在哪里，陶还没画到那一页，Anna 也没有。',
