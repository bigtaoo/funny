...
// Source: server/contracts/openapi-world.yml  (57 operations)
...
export const WORLD_ROUTES = [
  ...
  { method: 'GET' as const, path: "/world/siegeholds", operationId: "getSiegeHolds", security: ["bearerAuth"] },
  { method: 'GET' as const, path: "/world/stationed", operationId: "getStationed", security: ["bearerAuth"] },
  { method: 'GET' as const, path: "/world/orders", operationId: "getOrders", security: ["bearerAuth"] },
  { method: 'GET' as const, path: "/world/cities", operationId: "getWorldCities", security: ["bearerAuth"] },
  ...
  { method: 'POST' as const, path: "/world/team/{teamId}/cancel-siege", operationId: "cancelSiegeHold", security: ["bearerAuth"] },
