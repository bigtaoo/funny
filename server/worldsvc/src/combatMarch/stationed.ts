...
import type { MarchDoc, StationedDoc } from '../db';
...
export interface StationedHandlers {
...
export function StationedMixin<TBase extends MarchServiceBaseCtor>(Base: TBase): TBase & Constructor<StationedHandlers> {
