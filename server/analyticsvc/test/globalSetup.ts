...
// analyticsvc only does single-document atomic operations, so a standalone mongod is enough.
...
export const { setup, teardown } = createMongoHarness({ pkg: 'analyticsvc', replSet: false });
