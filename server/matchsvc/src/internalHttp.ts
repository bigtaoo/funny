    ...
    void (async () => {
      ...
      try {
        ...
        switch (req.url) {
          ...
          case '/mm/room/create':
            svc.roomCreate(str(b.accountId), str(b.name), str(b.publicId), str(b.equippedTitle), str(b.avatarId), strArr(b.deck), strArr(b.equippedSkins));
            break;
          case '/mm/room/join':
            svc.roomJoin(str(b.accountId), str(b.name), str(b.publicId), str(b.code), str(b.equippedTitle), str(b.avatarId), strArr(b.deck), strArr(b.equippedSkins));
            break;
          case '/mm/room/ready':
          ...
          case '/mm/queue/enqueue':
            await svc.enqueue(str(b.accountId), str(b.name), str(b.publicId), num(b.elo, 1000), str(b.equippedTitle), str(b.avatarId), str(b.platform), strArr(b.deck), strArr(b.equippedSkins));
            break;
            ...
            svc.duelInvite(
              {
                ...
                equippedTitle: str(b.equippedTitle), avatarId: str(b.avatarId), equippedSkins: strArr(b.equippedSkins), deck: strArr(b.deck),
              },
              str(b.toAccountId),
            );
            break;
