...
// Source: server/contracts/openapi.yml  (70 operations)
...
export interface MetaHandlers {
  ...
  pveMerge(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
...
export const ROUTES = [
  ...
  { method: 'POST' as const, url: "/pve/merge", operationId: "pveMerge", security: ["bearerAuth"] },
