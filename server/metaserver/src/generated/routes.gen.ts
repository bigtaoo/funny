...
// Source: server/contracts/openapi.yml  (91 operations)
...
export interface MetaHandlers {
  ...
  authCrazyGames(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  ...
  cancelAccountDeletion(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  ...
  submitAppeal(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  submitFeedback(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  ...
  claimRechargeMilestone(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  ...
  iapAppleSync(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  setAppleConsumptionConsent(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  ...
  cardsFuseBatch(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  ...
  claimWeeklyChest(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  ...
  equipAvatar(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  equipSkin(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  setFlag(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  getLobbyBadges(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
  ...
  reportUser(req: FastifyRequest, reply: FastifyReply): Promise<unknown>;
...
export const ROUTES = [
  ...
  { method: 'POST' as const, url: "/auth/crazygames", operationId: "authCrazyGames", security: [] },
  ...
  { method: 'POST' as const, url: "/account/cancel-deletion", operationId: "cancelAccountDeletion", security: ["bearerAuth"] },
  ...
  { method: 'POST' as const, url: "/account/appeal", operationId: "submitAppeal", security: ["bearerAuth"] },
  { method: 'POST' as const, url: "/feedback", operationId: "submitFeedback", security: ["bearerAuth"] },
  ...
  { method: 'POST' as const, url: "/recharge/claim", operationId: "claimRechargeMilestone", security: ["bearerAuth"] },
  ...
  { method: 'POST' as const, url: "/iap/apple/sync", operationId: "iapAppleSync", security: ["bearerAuth"] },
  { method: 'POST' as const, url: "/iap/apple/consumption-consent", operationId: "setAppleConsumptionConsent", security: ["bearerAuth"] },
  ...
  { method: 'POST' as const, url: "/cards/fuse-batch", operationId: "cardsFuseBatch", security: ["bearerAuth"] },
  ...
  { method: 'POST' as const, url: "/retention/weekly/claim", operationId: "claimWeeklyChest", security: ["bearerAuth"] },
  ...
  { method: 'PUT' as const, url: "/avatar/equip", operationId: "equipAvatar", security: ["bearerAuth"] },
  { method: 'PUT' as const, url: "/skin/equip", operationId: "equipSkin", security: ["bearerAuth"] },
  { method: 'PUT' as const, url: "/flags", operationId: "setFlag", security: ["bearerAuth"] },
  { method: 'GET' as const, url: "/lobby/badges", operationId: "getLobbyBadges", security: ["bearerAuth"] },
  ...
  { method: 'POST' as const, url: "/friends/report", operationId: "reportUser", security: ["bearerAuth"] },
            ...
            "save": {
              ...
              "properties": {
                ...
                "skinCounts": {
                  ...
                  "description": "Skin instance counts: skinId → total owned instance count"
                },
                "equipped": {
                  "type": "object",
                  "additionalProperties": {
        ...
        "data": {
          ...
          "properties": {
            "completed": {
              ...
              "counted from the start of `rounds`": null
            },
            "failed": {
              "type": "object",
