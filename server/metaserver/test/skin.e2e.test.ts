...
describe.skipIf(!mongo)('skin escrow/grant backend e2e', () => {
   ...
   *  to test duplicate-aware behavior; without this, escrow falls back to the legacy self-heal path
  ...
  // escrowable — only the LAST remaining copy of a currently-equipped skin is protected.
