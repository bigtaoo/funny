...
import type { AdminGachaPool, AnalyticsClient, AnalyticsQueryResult, AntiCheatClient, AntiCheatReviewRow, EventsClient, GachaPoolsClient, LadderClient, LadderSeasonInfo, MailDispatcher, MismatchClient, MismatchRow, PlayerClient, PlayerProfile, PlayerSummary, PromoClient, PromoCodeView, StatsClient, SuspiciousPveClient, SuspiciousPveRow, WorldClient, SlgWorldSummary } from './clients';
...
export class AdminService {
  ...
  private readonly gachaPools: GachaPoolsClient;
