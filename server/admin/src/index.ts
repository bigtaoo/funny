...
import { HttpMailDispatcher, HttpPlayerClient, HttpStatsClient } from './clients';
...
async function main(): Promise<void> {
  ...
  const svc = new AdminService({ cols: mongo.collections, stats, players, mail, now: () => Date.now() });
