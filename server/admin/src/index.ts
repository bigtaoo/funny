...
import { HttpAnalyticsClient, HttpAntiCheatClient, HttpMailDispatcher, HttpMismatchClient, HttpPlayerClient, HttpStatsClient, HttpSuspiciousPveClient, HttpWorldClient } from './clients';
...
async function main(): Promise<void> {
  ...
  const svc = new AdminService({ cols: mongo.collections, stats, players, antiCheat, mismatches, suspiciousPve, mail, analytics, world, now: () => Date.now() });
