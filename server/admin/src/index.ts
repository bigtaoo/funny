...
import { HttpAnalyticsClient, HttpAntiCheatClient, HttpMailDispatcher, HttpMismatchClient, HttpPlayerClient, HttpStatsClient, HttpWorldClient } from './clients';
...
async function main(): Promise<void> {
  ...
  const svc = new AdminService({ cols: mongo.collections, stats, players, antiCheat, mismatches, mail, analytics, world, now: () => Date.now() });
