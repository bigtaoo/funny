...
> 拍卖行/装备 + 成就系统 worktree 均已于 2026-06-21 合并 main 后删除；**成就系统 S9 全部落地**（S9-7/S9-8 在 `nice-wu-5c3478` 收口，见索引表）；**装备 E2 faucet + E6 洗练已于 2026-06-22 在 `gifted-feistel-42c356` 合并 main**；后续装备 E7 抽卡/E8 SLG/byUnit loadout 续做时重新 `git worktree add`。
