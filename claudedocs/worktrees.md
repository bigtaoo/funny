...
> 拍卖行/装备 worktree 已于 2026-06-21 合并 main 后删除；后续装备 E2~E4 续做时重新 `git worktree add`。
...
| S9 成就系统 | achievement | `feat/achievement-system` | `.claude\worktrees\achievement` | ✅ 服务端基座(S9-1/2/3/4)已合 main（merge be6fd2b3，2026-06-21）；worktree 保留可继续，改了 @nw/shared/openapi 公共依赖→其余 worktree 应 rebase origin/main 跟上 |
