...
本文 2026-08-17 按 500 行约定拆分。**小节编号一律未变**，源码/文档里既有的 `CAMPAIGN_DESIGN.md §N` 引用照旧有效——按下表找所在分册。

| 内容 | 文件 |
|---|---|
| 开头 ~ Notebook Wars — 单机战役模式设计文档 | **本文** |
| §4.9 新旋钮拍板、§5 数据结构、§6 引擎接入、§7–§12 元系统与路线 | [`CAMPAIGN_DESIGN_KNOBS.md`](CAMPAIGN_DESIGN_KNOBS.md) |
...
**接下页** → [`CAMPAIGN_DESIGN_KNOBS.md`](CAMPAIGN_DESIGN_KNOBS.md)：§4.9 新旋钮拍板、§5 数据结构、§6 引擎接入、§7–§12 元系统与路线。
