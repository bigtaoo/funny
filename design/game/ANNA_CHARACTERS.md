...
本文 2026-08-17 按 500 行约定拆分。**小节编号一律未变**，源码/文档里既有的 `ANNA_CHARACTERS.md §N` 引用照旧有效——按下表找所在分册。

| 内容 | 文件 |
|---|---|
| 开头 ~ Anna 方三角色设计文档 | **本文** |
| Aello / Björn / Lerna，以及三角色关系弧与设计注记 | [`ANNA_CHARACTERS_MONSTERS.md`](ANNA_CHARACTERS_MONSTERS.md) |

## 世界观定位

Anna Hartmann 是来自德国富裕家庭的少女。她的笔记本是她的欧洲——格林童话的骑士、中世纪铁匠城市、北欧神话的坚韧，还有她自己对"什么叫强大"的理解。她笔下的角色有荣耀感，有逻辑感，有一种"我已经算过了"的冷静。

涛的笔记本画的是中国历史军事语境里的人：步兵靠冲劲，弓手靠沉静，盾兵靠信任。Anna 的笔记本画的是欧洲骑士传奇语境里的战士：每一个人都曾相信靠自己就能赢，每一个人都在战场上学会了为什么不行。

两本笔记本相遇时，这种碰撞就是游戏的核心张力。

### 对位逻辑总表

| 方家（涛的笔记本） | Hartmann（Anna 的笔记本） | 对位核心 |
|---|---|---|
...
**接下页** → [`ANNA_CHARACTERS_MONSTERS.md`](ANNA_CHARACTERS_MONSTERS.md)：Aello / Björn / Lerna，以及三角色关系弧与设计注记。
