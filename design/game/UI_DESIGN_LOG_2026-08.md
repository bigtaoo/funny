...
> **本册到此为止（§26–§47）。§48 起见 [`UI_DESIGN_LOG_2026-09.md`](UI_DESIGN_LOG_2026-09.md)。**
> 滚册的理由是**体量**（本文曾到 1597 行，ADR-067 的上限是 500），不是月份——所以本册里有 2026-09-03/09-10 的条目（§45–§47），它们和 §44 是同一串上下文。
