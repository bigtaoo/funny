...
## 42. SLG 商城对齐大厅卡片语汇，并补上购买流程缺的三道闸（2026-08-30）

§41（批 1）把大世界四个面板的**尺度**统一了，同时留下一句「卡片语汇和购买流程另批处理」。这就是那一批（批 3）。范围只有商城一处，但它同时跨了两层：看得见的四项配色/描边差异，和看不见的四项流程缺陷——后者是审这四项时顺带查出来的真 bug，不是观感问题。
