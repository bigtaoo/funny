...
- 档位表 `RECHARGE_TIERS`（`server/shared/src/rechargeMilestone.ts`）：5 档，`thresholdCents` 600/2000/5000/10000/20000（$6/$20/$50/$100/$200），奖励为 coins+material 组合（**内容为 DRAFT，占位数值，上线前需要运营微调**，仅 coins/material 两种 kind，与战令一致排除卡/皮肤避免影响 PvP 强度或与皮肤付费冲突）。
