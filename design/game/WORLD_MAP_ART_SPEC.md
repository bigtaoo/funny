...
> · 竖屏（设计宽固定 1080）：L1 按「自己基地地皮占屏宽 4/5」反推 = `w×0.8/BASE_FOOTPRINT` = **288**，L2 = `w/11` = 98，L3 = 27（2026-09-15 起，见 [`SLG_LOG_2026-08.md`](SLG_LOG_2026-08.md) 当日条）。
> 也就是说 L1 的格子最大能到 288px：出图时别按 96px 的上限去想细节密度，L1 会把它放大到 3 倍。
