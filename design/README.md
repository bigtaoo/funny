...
| [CONTENT_MODERATION_DESIGN.md](game/CONTENT_MODERATION_DESIGN.md) | **内容治理（用户名/家族名/宗门名/聊天敏感词归一化+词库外部化/举报处理闭环/信誉分分级处罚/审核+申诉后台）；取代 SOC10 与 COMPLIANCE_GLOBAL §7** | 设计中 |
