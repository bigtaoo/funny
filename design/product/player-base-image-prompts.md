...
本文 2026-08-17 按 500 行约定拆分。**小节编号一律未变**，源码/文档里既有的 `player-base-image-prompts.md §N` 引用照旧有效——按下表找所在分册。

| 内容 | 文件 |
|---|---|
| 开头 ~ 玩家基地（desk）图片 Prompt | **本文** |
| Lv.1–10 的 v2 prompt 与逐张返工记录 | [`player-base-image-prompts-v2.md`](player-base-image-prompts-v2.md) |
...
**接下页** → [`player-base-image-prompts-v2.md`](player-base-image-prompts-v2.md)：Lv.1–10 的 v2 prompt 与逐张返工记录。
