...
> **批次 6 在单独文件**：[`tab-icon-art-prompts-batch6.md`](tab-icon-art-prompts-batch6.md) —— **大厅首页**主视觉（前五批全在二级页面，首页四处主视觉一直是程序图），3 张新图 + 段位 chip 复用 `leaderboardTabIcon`，**2026-08-17 出图+接线全部完成**，至此光栅图标共 46 个 / 138 张 PNG。
