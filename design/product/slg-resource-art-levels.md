...
>
> **✅ 已拍板并落地（2026-09-15）**：走的是「给竖屏单独收紧最近档」，但定义换了个锚——竖屏 L1 不再声明「一屏几格」，而是声明「自己基地的地皮占屏宽 4/5」（`PORTRAIT_L1_BASE_WIDTH_FRAC = 0.8`，tp = `w × 0.8 / BASE_FOOTPRINT` = 288），旧的 L1 退成 L2。一屏 3660 → 约 300 格，这面文字墙自动消解。横屏未动。详见 [`SLG_LOG_2026-08.md` 2026-09-15 条](../game/SLG_LOG_2026-08.md)。
