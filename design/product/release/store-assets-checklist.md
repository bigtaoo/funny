...
| 素材 | 规格 | 状态 |
|---|---|---|
| 缩略图 | 按 CrazyGames 开发者要求（通常 16:9，建议 1280×720） | 待美术（横版 16:9，现有批次都是竖版，需单独跑一档横屏尺寸） |
| 游戏标题/描述 | 英文（见 §0.1 EN） | — |
| 操作说明 | 鼠标/触屏操作说明 | 待补 |
...
|---|---|---|---|---|---|
| iOS | 🟡 截图初版已出；图标待美术 | §1.3 待填 | §1.4 待填 | §1.5 | 全球版 §5.2 |
| Google Play | 🟡 截图初版已出；图标/特征图待美术 | §2.3 待填 | §2.4 待填 | §2.5 | 全球版 §5.2 |
| 微信小游戏 | 待美术 | §3.3 待评估 | 隐私政策(CN) | §3.2（依版号） | 中国区 §5.1 |
| CrazyGames | 待美术 | 平台要求 | 隐私政策 | §4.2 | 全球版 §5.2 |

> **依赖提醒**：图标（iOS 1024 / Play 512 + 特征图 1024×500 / 微信分享图）仍「待美术」，**截图已有可复跑的采集管线**（§0.4）；隐私标签答案依赖 §0.3 定稿（已与隐私政策对齐）；中国区整块依赖版号流程（Track 2 L2-4）。
