...
编辑器的覆盖率**百分比**从此受仓库 90% 门禁约束（此前只有「必须产出 coverage/」受门禁）。口径见 [ADR-070](../../DECISIONS_ADR-070-085.md#adr-070-tools-覆盖率口径-scoped-include-与-reported-not-gated-过渡--accepted--2026-08-20) 与 [`claudedocs/tools-testing.md`](../../../claudedocs/tools-testing.md)；这里只记与本编辑器结构有关的部分。
