...
| [ADR-088](DECISIONS_ADR-070-onward.md#adr-088-会话改滑动续期响应头-x-nw-tokentoken-真失效时强制退回登录页--accepted--2026-09-10) | 会话改滑动续期（响应头 `x-nw-token`），token 真失效时强制退回登录页 | Accepted | 2026-09-10 |
