...
| [ADR-090](DECISIONS_ADR-070-onward.md#adr-090-金币库从约定隔离升级为凭据隔离每服务一个最小权限-mongo-用户--accepted--2026-09-12) | 金币库从「约定隔离」升级为「凭据隔离」：每服务一个最小权限 Mongo 用户 | Accepted | 2026-09-12 |
